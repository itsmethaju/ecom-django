...
(function (window, document, $, undefined) {
  ...
  var W = $(window),
    ...
    return el && !(el.style.overflow && el.style.overflow === 'hidden') && (el.clientWidth && el.scrollWidth > el.clientWidth || el.clientHeight && el.scrollHeight > el.clientHeight);
      ...
      getScalar = function getScalar(value, dim) {
  ...
  $.extend(F, {
    ...
    showLoading: function showLoading() {
      var el, viewport;
      F.hideLoading(); // If user will press the escape-button, the request will be canceled
      ...
      if (keys) {
        D.bind('keydown.fb', function (e) {
          var code = e.which || e.keyCode,
              target = e.target || e.srcElement; // Ignore key combinations and key events within form elements
    ...
    _setDimension: function _setDimension() {
      ...
      hPadding = skin.outerHeight(true) - skin.height(); // Any space between content and viewport (margin, padding, border, title)
      ...
      if (current.fitToView) {
        ...
        wrap.width(getScalar(width + wPadding)); // Real wrap dimensions
    ...
    _afterZoomIn: function _afterZoomIn() {
      ...
      F.reposition(); // Assign a click event
  ...
  F.helpers.overlay = {
    ...
    afterClose: function afterClose(opts) {
      var that = this,
          speed = opts.speedOut || 0; // Remove overlay if exists and fancyBox is not opening
    ...
    beforeShow: function beforeShow(opts) {
      ...
      switch (type) {
        ...
        default:
          // 'float'
          target = F.skin;
          title.appendTo('body').width(title.width()) //This helps for some browsers
          .wrapInner('<span class="child"></span>'); //Increase bottom margin so this title will also fit into viewport
